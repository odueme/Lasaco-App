                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Image(image: AssetImage('Images/motor.png')),
                        SizedBox(width: 8),
                        Text('Travel Insurance', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color:  Color(0xFF0D6590)))
                      ],
                    ),
                    SizedBox(height: 10,),
                    Row(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Image(image: AssetImage('Images/motor.png')),
                        SizedBox(width: 8),
                        Text('Marine Insurance', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color:  Color(0xFF0D6590)))
                      ],
                    ),
                    SizedBox(height: 10,),
                    Row(
